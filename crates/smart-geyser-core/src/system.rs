...
mod tests {
    ...
    #[test]
    fn solar_pumped_cop_is_one() {
        assert_eq!(HeatingSystem::SolarPumped.effective_cop(), 1.0);
    }
    ...
    fn is_solar_pumped_predicate() {
        ...
        assert!(HeatingSystem::SolarPumped.is_solar_pumped());
    ...
    fn is_electric_only_predicate() {
        ...
        assert!(!HeatingSystem::SolarPumped.is_electric_only());
    }
